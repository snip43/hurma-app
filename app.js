...
function renderTopbar(user) {
  return `
    <header class="topbar">
      <button class="brand brand-home" type="button" data-action="go-home" aria-label="На главную">
        <div class="brand-mark">Х</div>
        <div>
          <h1 class="brand-title">ХурМа</h1>
...
const bindEventsBeforeBrandHome = bindEvents;
bindEvents = function bindEventsWithBrandHome() {
  bindEventsBeforeBrandHome();

  document.querySelectorAll("[data-action='go-home'], .topbar .brand").forEach((brand) => {
